...
// Page adress
#define ADRESS_BYTE_PAGE_1_COM 0x10000
#define ADRESS_BYTE_PAGE_2_MAN 0x11000
#define ADRESS_BYTE_PAGE_3_STD 0x12000
#define ADRESS_BYTE_PAGE_4_STD 0x13000
#define ADRESS_BYTE_PAGE_5_CAL 0x14000
