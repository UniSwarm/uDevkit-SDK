...
int board_init_io(void)
{
    ...
    {
        _board_leds[led + LED1R] = ccp(led + 1);
        ccp_open(_board_leds[led + LED1R]);
        ccp_setMode(_board_leds[led + LED1R], CCP_MODE_PWM);
        ccp_setPeriod(_board_leds[led + LED1R], 0x7F8);
        ccp_setCompare(_board_leds[led + LED1R], 0, 0x7FF);
        ccp_enable(_board_leds[led + LED1R]);
    }
