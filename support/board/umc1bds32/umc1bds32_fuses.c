...
#pragma config S1ISOLAT = OFF  // Isolate the Slave core subsystem from the master subsystem during Debug (The slave can
...
#pragma config S1SSRE =                                                                                                \
    ON  // Slave Slave Reset Enable (Slave generated resets will reset the Slave Enable Bit in the MSI module)
#pragma config S1MSRE =                                                                                                \
    ON  // Master Slave Reset Enable (The master software oriented RESET events (RESET Op-Code, Watchdog timeout, TRAP
...
#pragma config CPRB9 = SLV1   // Pin RB9 Ownership Bits->Slave core owns pin, QEI1A_TX_DATA
...
#pragma config CPRD2 = SLV1   // Pin RD2 Ownership Bits->Master core owns pin
...
#    pragma config CPRE12 = SLV1  // Pin RE12 Ownership Bits->Master core owns pin
#    pragma config CPRE13 = SLV1  // Pin RE13 Ownership Bits->Master core owns pin
...
// FMBXM
#pragma config MBXM0 =                                                                                                 \
    M2S  // Mailbox 0 data direction (Mailbox register configured for Master data read (Master to Slave data transfer)
#pragma config MBXM1 =                                                                                                 \
    M2S  // Mailbox 1 data direction (Mailbox register configured for Master data read (Master to Slave data transfer)
#pragma config MBXM2 =                                                                                                 \
    M2S  // Mailbox 2 data direction (Mailbox register configured for Master data read (Master to Slave data transfer)
#pragma config MBXM3 =                                                                                                 \
    M2S  // Mailbox 3 data direction (Mailbox register configured for Master data read (Master to Slave data transfer)
#pragma config MBXM4 =                                                                                                 \
    M2S  // Mailbox 4 data direction (Mailbox register configured for Master data read (Master to Slave data transfer)
#pragma config MBXM5 =                                                                                                 \
    S2M  // Mailbox 5 data direction (Mailbox register configured for Master data read (Slave to Master data transfer)
#pragma config MBXM6 =                                                                                                 \
    S2M  // Mailbox 6 data direction (Mailbox register configured for Master data read (Slave to Master data transfer)
#pragma config MBXM7 =                                                                                                 \
    S2M  // Mailbox 7 data direction (Mailbox register configured for Master data read (Slave to Master data transfer)
#pragma config MBXM8 =                                                                                                 \
    S2M  // Mailbox 8 data direction (Mailbox register configured for Master data read (Slave to Master data transfer)
#pragma config MBXM9 =                                                                                                 \
    S2M  // Mailbox 9 data direction (Mailbox register configured for Master data read (Slave to Master data transfer)
#pragma config MBXM10 = M2S  // Mailbox 10 data direction (Mailbox register configured for Master data read (Slave to
                             // Master data transfer)
#pragma config MBXM11 = M2S  // Mailbox 11 data direction (Mailbox register configured for Master data read (Slave to
                             // Master data transfer)
#pragma config MBXM12 = M2S  // Mailbox 12 data direction (Mailbox register configured for Master data read (Slave to
                             // Master data transfer)
#pragma config MBXM13 = S2M  // Mailbox 13 data direction (Mailbox register configured for Master data read (Slave to
                             // Master data transfer)
#pragma config MBXM14 = S2M  // Mailbox 14 data direction (Mailbox register configured for Master data read (Slave to
                             // Master data transfer)
#pragma config MBXM15 = S2M  // Mailbox 15 data direction (Mailbox register configured for Master data read (Slave to
                             // Master data transfer)
