...
#pragma config CPRB9 = SLV1   // Pin RB9 Ownership Bits->Secondary core owns pin, QEI1A_TX_DATA
...
#pragma config CPRC5 = SLV1   // Pin RC5 Ownership Bits->Secondary core owns pin
...
#pragma config CPRC11 = SLV1  // Pin RC11 Ownership Bits->Secondary core owns pin
#pragma config CPRC12 = MSTR  // Pin RC12 Ownership Bits->Primary core owns pin
#pragma config CPRC13 = SLV1  // Pin RC13 Ownership Bits->Secondary core owns pin
...
// FCFGPRD0
#pragma config CPRD0 = SLV1   // Pin RD0 Ownership Bits->Secondary core owns pin
#pragma config CPRD1 = SLV1   // Pin RD1 Ownership Bits->Secondary core owns pin
#pragma config CPRD2 = SLV1   // Pin RD2 Ownership Bits->Secondary core owns pin
...
#pragma config CPRE12 = SLV1  // Pin RE12 Ownership Bits->Secondary core owns pin
...
#pragma config MBXHSC = MBX12  // Mailbox handshake protocol block C register assignment (MSIxMBXD15 assigned to mailbox
...
// FMBXHSEN
#pragma config HSAEN = ON   // Mailbox A data flow control protocol block enable (Mailbox data flow control handshake
                            // protocol block enabled)
#pragma config HSBEN = ON   // Mailbox B data flow control protocol block enable (Mailbox data flow control handshake
                            // protocol block enabled)
...
#pragma config HSDEN = ON   // Mailbox D data flow control protocol block enable (Mailbox data flow control handshake
                            // protocol block disabled)
#pragma config HSEEN = OFF  // Mailbox E data flow control protocol block enable (Mailbox data flow control handshake
                            // protocol block disabled)
#pragma config HSFEN = OFF  // Mailbox F data flow control protocol block enable (Mailbox data flow control handshake
                            // protocol block disabled)
#pragma config HSGEN = OFF  // Mailbox G data flow control protocol block enable (Mailbox data flow control handshake
                            // protocol block disabled)
#pragma config HSHEN = OFF  // Mailbox H data flow control protocol block enable (Mailbox data flow control handshake
                            // protocol block disabled)
