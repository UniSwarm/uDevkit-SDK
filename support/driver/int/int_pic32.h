 ...
 *
 * @date March 22, 2023, 06:54 PM
 *
 * @brief Global interrupts and external interrupts support drivers for PIC32MK,
...
// SOFT, SRS, AUTO, SAVEALL
#define INT_DEFAULT_MODE SRS

#define IPLPRI(PRI, MODE)          IPL##PRI##MODE
#define IPLPRIMODE2(PRI, MODE)     IPLPRIMODE(PRI, MODE)
#define IPLPRIMODE(PRI, MODE)      IPLPRI(PRI, MODE)
#define INT_ISR(VECTOR, PRI, MODE) __ISR(VECTOR, IPLPRIMODE(PRI, MODE))
    ...
    || defined(DEVICE_32MK1024MCF100) || defined(DEVICE_32MK1024MCM064) || defined(DEVICE_32MK1024MCM100) || defined(DEVICE_32MM0016GPL020)                    \
    ...
    || defined(DEVICE_32MM0064GPM028) || defined(DEVICE_32MM0064GPM036) || defined(DEVICE_32MM0064GPM048) || defined(DEVICE_32MM0064GPM064)                    \
    ...
    || defined(DEVICE_32MX130F256B) || defined(DEVICE_32MX130F256D) || defined(DEVICE_32MX150F128B) || defined(DEVICE_32MX150F128C)                            \
    || defined(DEVICE_32MX150F128D) || defined(DEVICE_32MX150F256H) || defined(DEVICE_32MX150F256L) || defined(DEVICE_32MX154F128B)                            \
    || defined(DEVICE_32MX154F128D) || defined(DEVICE_32MX170F256B) || defined(DEVICE_32MX170F256D) || defined(DEVICE_32MX170F512H)                            \
    || defined(DEVICE_32MX170F512L) || defined(DEVICE_32MX174F256B) || defined(DEVICE_32MX174F256D) || defined(DEVICE_32MX210F016B)                            \
    || defined(DEVICE_32MX210F016C) || defined(DEVICE_32MX210F016D) || defined(DEVICE_32MX220F032B) || defined(DEVICE_32MX220F032C)                            \
    || defined(DEVICE_32MX220F032D) || defined(DEVICE_32MX230F064B) || defined(DEVICE_32MX230F064C) || defined(DEVICE_32MX230F064D)                            \
    || defined(DEVICE_32MX230F128H) || defined(DEVICE_32MX230F128L) || defined(DEVICE_32MX230F256B) || defined(DEVICE_32MX230F256D)                            \
    || defined(DEVICE_32MX250F128B) || defined(DEVICE_32MX250F128C) || defined(DEVICE_32MX250F128D) || defined(DEVICE_32MX250F256H)                            \
    || defined(DEVICE_32MX250F256L) || defined(DEVICE_32MX254F128B) || defined(DEVICE_32MX254F128D) || defined(DEVICE_32MX270F256B)                            \
    || defined(DEVICE_32MX270F256D) || defined(DEVICE_32MX270F512H) || defined(DEVICE_32MX270F512L) || defined(DEVICE_32MX274F256B)                            \
    ...
    || defined(DEVICE_32MX360F512L) || defined(DEVICE_32MX370F512H) || defined(DEVICE_32MX370F512L) || defined(DEVICE_32MX420F032H)                            \
    || defined(DEVICE_32MX430F064H) || defined(DEVICE_32MX430F064L) || defined(DEVICE_32MX440F128H) || defined(DEVICE_32MX440F128L)                            \
    || defined(DEVICE_32MX440F256H) || defined(DEVICE_32MX440F512H) || defined(DEVICE_32MX450F128H) || defined(DEVICE_32MX450F128L)                            \
    || defined(DEVICE_32MX450F256H) || defined(DEVICE_32MX450F256L) || defined(DEVICE_32MX460F256L) || defined(DEVICE_32MX460F512L)                            \
    || defined(DEVICE_32MX470F512H) || defined(DEVICE_32MX470F512L) || defined(DEVICE_32MX530F128H) || defined(DEVICE_32MX530F128L)                            \
    || defined(DEVICE_32MX534F064H) || defined(DEVICE_32MX534F064L) || defined(DEVICE_32MX550F256H) || defined(DEVICE_32MX550F256L)                            \
    || defined(DEVICE_32MX564F064H) || defined(DEVICE_32MX564F064L) || defined(DEVICE_32MX564F128H) || defined(DEVICE_32MX564F128L)                            \
    || defined(DEVICE_32MX570F512H) || defined(DEVICE_32MX570F512L) || defined(DEVICE_32MX575F256H) || defined(DEVICE_32MX575F256L)                            \
