/**
 * @file uart_dspic33a.h
 * @author Sebastien CAUX (sebcaux)
 * @copyright UniSwarm 2024
 *
 * @date August 3, 2024, 03:40 PM
 *
 * @brief UART support driver for dsPIC33A
 *
...
#ifndef UART_DSPIC33A_H
#define UART_DSPIC33A_H
