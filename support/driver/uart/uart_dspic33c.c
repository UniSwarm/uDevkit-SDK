...
{
    char uart_tmpchar[1];
    while (!U1STAHbits.UTXBF && fifo_pop(&_uarts[0].buffTx, uart_tmpchar, 1) == 1)
    {
...
{
    char uart_tmpchar[1];
    while (!U2STAHbits.UTXBF && fifo_pop(&_uarts[1].buffTx, uart_tmpchar, 1) == 1)
    {
...
{
    char uart_tmpchar[1];
    while (!U3STAHbits.UTXBF && fifo_pop(&_uarts[2].buffTx, uart_tmpchar, 1) == 1)
    {
