...
#    endif
static uint8_t __attribute__((aligned(4), noload)) _can3_fifo_buffer[CAN3_FIFO_SIZE];
#endif
...
#    endif
static uint8_t __attribute__((aligned(4), noload)) _can4_fifo_buffer[CAN4_FIFO_SIZE];
#endif
