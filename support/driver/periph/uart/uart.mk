...
test_uart:
	xc16-gcc -DARCHI_dspic33f -DDEVICE_33FJ16MC102 -mcpu=33FJ16MC102 -c -I$(RTPROG)include $(RTPROG)support/driver/periph/uart/uart_pic24_dspic33.c -o uart_pic24_dspic33.o
