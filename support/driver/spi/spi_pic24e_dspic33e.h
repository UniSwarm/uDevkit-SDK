...
#define SPI_PIC24E_DSPIC33E_H
...
#if defined(DEVICE_33CH64MP202S1) || defined(DEVICE_33CH64MP203S1) || defined(DEVICE_33CH64MP205S1)                    \
    ...
    || defined(DEVICE_33CH512MP506S1) || defined(DEVICE_33CH512MP508S1) || defined(DEVICE_33EP16GS202)                 \
...
#    define SPI_COUNT 1
    ...
    || defined(DEVICE_24EP512MC204) || defined(DEVICE_24EP512MC206) || defined(DEVICE_33CH64MP202)                     \
    || defined(DEVICE_33CH64MP203) || defined(DEVICE_33CH64MP205) || defined(DEVICE_33CH64MP206)                       \
    || defined(DEVICE_33CH64MP208) || defined(DEVICE_33CH64MP502) || defined(DEVICE_33CH64MP503)                       \
    ...
    || defined(DEVICE_33CH512MP508) || defined(DEVICE_33CK32MC102) || defined(DEVICE_33CK32MC103)                      \
    || defined(DEVICE_33CK32MC105) || defined(DEVICE_33CK64MC102) || defined(DEVICE_33CK64MC103)                       \
    || defined(DEVICE_33CK64MC105) || defined(DEVICE_33EDV64MC205) || defined(DEVICE_33EP16GS502)                      \
    ...
    || defined(DEVICE_33EP64MC504) || defined(DEVICE_33EP64MC506) || defined(DEVICE_33EP128GP502)                      \
    || defined(DEVICE_33EP128GP504) || defined(DEVICE_33EP128GP506) || defined(DEVICE_33EP128MC202)                    \
    || defined(DEVICE_33EP128MC204) || defined(DEVICE_33EP128MC206) || defined(DEVICE_33EP128MC502)                    \
    || defined(DEVICE_33EP128MC504) || defined(DEVICE_33EP128MC506) || defined(DEVICE_33EP256GP502)                    \
    ...
    || defined(DEVICE_33EP256MC504) || defined(DEVICE_33EP256MC506) || defined(DEVICE_33EP512GP502)                    \
    ...
    || defined(DEVICE_33EP512MC504) || defined(DEVICE_33EP512MC506) || defined(DEVICE_33EV32GM002)                     \
...
#    define SPI_COUNT 2
#elif defined(DEVICE_33CK32MP102) || defined(DEVICE_33CK32MP103) || defined(DEVICE_33CK32MP105)                        \
    ...
    || defined(DEVICE_33CK512MP606) || defined(DEVICE_33CK512MP608) || defined(DEVICE_33EP64GS708)                     \
    || defined(DEVICE_33EP64GS804) || defined(DEVICE_33EP64GS805) || defined(DEVICE_33EP64GS806)                       \
    || defined(DEVICE_33EP64GS808) || defined(DEVICE_33EP128GM304) || defined(DEVICE_33EP128GM306)                     \
    || defined(DEVICE_33EP128GM310) || defined(DEVICE_33EP128GM604) || defined(DEVICE_33EP128GM706)                    \
    || defined(DEVICE_33EP128GM710) || defined(DEVICE_33EP128GS702) || defined(DEVICE_33EP128GS704)                    \
    ...
    || defined(DEVICE_33EP128GS808) || defined(DEVICE_33EP256GM304) || defined(DEVICE_33EP256GM306)                    \
    || defined(DEVICE_33EP256GM310) || defined(DEVICE_33EP256GM604) || defined(DEVICE_33EP256GM706)                    \
    || defined(DEVICE_33EP256GM710) || defined(DEVICE_33EP512GM304) || defined(DEVICE_33EP512GM306)                    \
    || defined(DEVICE_33EP512GM310) || defined(DEVICE_33EP512GM604) || defined(DEVICE_33EP512GM706)                    \
    || defined(DEVICE_33EP512GM710)
#    define SPI_COUNT 3
#elif defined(DEVICE_24EP256GU810) || defined(DEVICE_24EP256GU814) || defined(DEVICE_24EP512GP806)                     \
    || defined(DEVICE_24EP512GU810) || defined(DEVICE_24EP512GU814) || defined(DEVICE_33EP256MU806)                    \
    || defined(DEVICE_33EP256MU810) || defined(DEVICE_33EP256MU814) || defined(DEVICE_33EP512GP806)                    \
