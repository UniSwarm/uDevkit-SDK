/**
 * @file timer_dspic33a.h
 * @author Sebastien CAUX (sebcaux)
 * @copyright UniSwarm 2024
 *
 * @date August 3, 2024, 03:42 PM
 *
 * @brief TIMER support driver for dsPIC33A
 *
...
#ifndef TIMER_DSPIC33A_H
#define TIMER_DSPIC33A_H
