...
int main(void)
{
    JsonBuffer json;
    char data[500];
    // sprintf(data, "{\"name1\": \"value1\",\"name2\": \"42\",\"list1\": [\"name10\": \"value10\",\"name11\":
    // \"value11\",\"name12\": \"value12\" ],\"obj1\": {\"name3\": \"42\",\"name4\": \"42\" },\"obj2\": {\"name5\":
    // \"42\",\"name6\": \"42\" },\"list2\": [\"name20\": \"value20\",\"name21\": \"value21\",\"name22\": \"value22\" ]
    // }");
