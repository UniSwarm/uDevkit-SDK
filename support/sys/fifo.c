...
int main(void)
{
    ...
    fifo_push_str(&fifo2, "1234\r\n");
    while (fifo_pop(&fifo2, uart_tmpchar, 1) == 1)
    {
        printf("%c", uart_tmpchar[0]);
    }

    fifo_push_str(&fifo2, "123456789AB\r\n");
    while (fifo_pop(&fifo2, uart_tmpchar, 1) == 1)
    {
        printf("%c", uart_tmpchar[0]);
    }

    fifo_push_str(&fifo2, "123456789ABCDEF\r\n");
    while (fifo_pop(&fifo2, uart_tmpchar, 1) == 1)
    {
        printf("%c", uart_tmpchar[0]);
    }

    fifo_push_str(&fifo2, "123456789ABCDEF123456789ABCDEF0\r\n");
    while (fifo_pop(&fifo2, uart_tmpchar, 1) == 1)
    {
        printf("%c", uart_tmpchar[0]);
    }
